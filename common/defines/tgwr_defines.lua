...
NDefines.NDiplomacy.TENSION_NO_CB_WAR = 6									-- Vanilla is 15
NDefines.NDiplomacy.TENSION_CB_WAR = 3										-- Vanilla is 5
NDefines.NDiplomacy.TENSION_ANNEX_NO_CLAIM = 0.2								-- Vanilla is 2
NDefines.NDiplomacy.TENSION_ANNEX_CLAIM = 0.15									-- Vanilla is 1
NDefines.NDiplomacy.TENSION_ANNEX_CORE = 0.1								  	-- Vanilla is 0.5
NDefines.NDiplomacy.TENSION_PUPPET = 0.01									-- Vanilla is 2
...
NDefines.NAI.MAX_DISTANCE_NALAV_INVASION = 150.0
