...
NDiplomacy = {
	...
	TENSION_TIME_SCALE_MONTHLY_FACTOR = -0.005,		-- Timed tension scale will be modified by this amount starting with TENSION_TIME_SCALE_START_DATE #TGWR
...
NMilitary = {
	...
	DIG_IN_FACTOR = 0.04,						   -- bonus factor for each dug-in level
